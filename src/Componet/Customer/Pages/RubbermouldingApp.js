...
import img1 from '../image/ruber1.webp';
import img2 from '../image/ruber2.webp';




export default function RubbermouldingApp() {
  return (
    <div >
      <NavbarApp />
      <h1 className='hyprestext container'>Rubber Moulding Press configurations</h1>

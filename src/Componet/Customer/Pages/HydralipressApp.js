...
import img1 from '../image/press1.jpg';
import img2 from '../image/htype.webp';




export default function HydralipressApp() {
  return (
    <div >
      <NavbarApp />
      <h1 className='hyprestext container'>Hydralic Press configurations</h1>
